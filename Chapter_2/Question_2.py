...
class IntArray():
    ...
    def remove(self, index:int) -> int:
        ...
        if self._size > 0:
            ...
            # Copy elements after the removal point, shifted back by one position
            if index < self._size:
                source_start = (index + 1) * self._bytes_per_element
                dest_start = index * self._bytes_per_element
